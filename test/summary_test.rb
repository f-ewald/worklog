...
class SummaryTest < Minitest::Test
  ...
  def test_generate_summary
    entries = [
      LogEntry.new(Time.new(2020, 1, 1, 10, 0, 0), nil, 'ticket-123', 'https://example.com/', true,
                   'Created a feature to improve the performance of microservices by 200%'),
      LogEntry.new(Time.new(2020, 1, 1, 11, 0, 0), nil, 'ticket-123', 'https://example.com/', true,
